...
- induction beta.
  + induction gamma.
    * intros.
      ...
      apply ord_le_respects_succ_converse in H0.
      apply IHalpha with beta; assumption.
    * intros.
...
Lemma ord_le_sup': forall beta:Ordinal,
    beta <= beta /\
...
Corollary ord_le_refl: forall alpha:Ordinal, alpha <= alpha.
Proof.
intros.
destruct (ord_le_sup' alpha).
assumption.
Qed.
